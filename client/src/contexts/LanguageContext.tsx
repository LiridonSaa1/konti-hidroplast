...
const translations = {
  ...
  mk: {
    ...
    "aboutUs.companyStoryText2":
      "Од тога време, компанијата се развиваше и експанзираше, водејќи се со стремеж да доставува највисоки стандарди на квалитет и услуги на своите клиенти.",
    "aboutUs.companyStoryText3":
      "Денес, Конти Хидропласт е горда на својот пат на успех и продолжува да инвестира во иднината, вклучувајќи ги и најновите технологии и иновации.",
    "aboutUs.companyStoryText4":
      "Нашата компанија е посветена на одржлив развој и еколошка одговорност, што ја прави избор број еден за клиентите кои бараат висококвалитетни и еколошки пријателски решенија.",
    "aboutUs.companyStoryText5":
      "Со силна посветеност на квалитетот, иновациите и задоволството на клиентите, Конти Хидропласт продолжува да биде водечка сила во индустријата за цевки.",
