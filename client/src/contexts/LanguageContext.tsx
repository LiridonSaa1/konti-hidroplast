...
const translations = {
  en: {
    ...
    'newsPage.noContent.line1': 'This article is currently being updated with more detailed content.',
  ...
  mk: {
    ...
    'newsPage.noContent.line1': 'Оваа статија моментално се ажурира со детални содржини.',
    'newsPage.noContent.line2': 'Ве молиме повторно проверете наскоро за целосната статија.',
    ...
    'admin.confirm.delete': 'Дали сте сигурни дека сакате да го избришете овој елемент?',
    'admin.noData': 'Нема достапни податоци',
    'admin.selectFile': 'Изберете датотека',
    'admin.dragDropFile': 'Повлечете и спуштете датотека овде или кликнете за избор',
  ...
  de: {
    ...
    'newsPage.noContent.line1': 'Dieser Artikel wird derzeit mit detaillierteren Inhalten aktualisiert.',
    'newsPage.noContent.line2': 'Bitte schauen Sie bald wieder vorbei für den vollständigen Artikel.',
    ...
    'admin.confirm.delete': 'Sind Sie sicher, dass Sie dieses Element löschen möchten?',
