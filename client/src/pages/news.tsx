...
const newsArticles = [
  ...
  {
    id: 2,
    title: "Konti Hidroplast Donated €100,000 to the Public General Hospital in Gevgelija",
    excerpt: "The Public General Hospital with expanded services in Gevgelija received a donation of €100,000",
  ...
  },
  {
    ...
    excerpt: "Sustainability and environmental responsibility are key values in our company's operations and development.",
  ...
  },
  {
    ...
    excerpt: "Leading industry associations plastic pipe play a pivotal role in ensuring safe, efficient infrastructure.",
    image: "https://konti-hidroplast.com.mk/wp-content/uploads/2025/06/HDPE-plastic-pipes-installed-in-Dutch-flood-protection-systems-as-a-climate-resilience-solution.-min.png",
    date: "2025-06-10",
    author: "Konti Team",
    category: "Industry",
  ...
  },
  {
    ...
    excerpt: "Proactive maintaining healthy pipe systems in your home isn't just about convenience-it's about safety and efficiency.",
    image: "https://konti-hidroplast.com.mk/wp-content/uploads/2025/06/comparison-of-corroded-and-healthy-copper-pipes-min.png",
    date: "2025-06-05",
    author: "Konti Team",
  ...
  },
  {
    ...
    excerpt: "In Scandinavian manufacturing, industrial piping systems form the backbone of essential utilities—handling water, gas, and more.",
    image: "https://konti-hidroplast.com.mk/wp-content/uploads/2025/05/plastic-pipes-industrial-pipe-network-min.png",
    date: "2025-05-25",
    author: "Konti Team",
    category: "Industrial",
  ...
  },
  {
    ...
    excerpt: "Explore the latest manufacturing techniques that make our PE pipes the most reliable in the industry.",
    image: "https://konti-hidroplast.com.mk/wp-content/uploads/2025/06/HDPE-plastic-pipes-installed-in-Dutch-flood-protection-systems-as-a-climate-resilience-solution.-min.png",
    date: "2025-05-15",
    author: "Konti Team",
  ...
  },
  {
    ...
    excerpt: "Understanding how our PE pipes meet and exceed international water quality standards for safe drinking water systems.",
    image: "https://konti-hidroplast.com.mk/wp-content/uploads/2025/06/comparison-of-corroded-and-healthy-copper-pipes-min.png",
    date: "2025-05-10",
    author: "Konti Team",
    category: "Standards",
  ...
  },
  {
    ...
    excerpt: "How HDPE pipes contribute to sustainable infrastructure development and environmental protection initiatives.",
    image: "https://konti-hidroplast.com.mk/wp-content/uploads/2025/05/plastic-pipes-industrial-pipe-network-min.png",
    date: "2025-05-01",
    author: "Konti Team",
    category: "Sustainability",
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white pt-32 pb-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Stay informed with the latest industry developments, company updates, technological innovations, and expert insights from the world of pipe manufacturing.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Discover the latest developments, innovations, and insights from Konti Hidroplast and the pipe manufacturing industry.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Want to receive the latest news and updates directly in your inbox? Contact us to stay connected.
            </p>
            <a
              href="#contact"
